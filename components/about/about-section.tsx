  ...
  return (
        <section className='about py-20 bg-slate-100' id='about'>
            <div className='mx-auto max-w-[61rem]'>
                <div className="about-content grid items-center justify-center
                 grid-cols-1 md:grid-cols-2 gap-y-10 px-10">
                    ...
                    <div className='h-full mx-auto text-center md:text-left max-w-[525px]'>
                        ...
                        <h3 className={styles.description}>A creative Full-Stack Developer based in Tlaxcala, México📍</h3>
                        <p className={styles.pTag}>I am currently working with Next js + other front end technologies and django/node for the backend. </p>
                    </div>
                </div>
            </div>
        </section>
