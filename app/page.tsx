  ...
  <section className='hero h-auto py-20 relative'>
    <div className='container mx-auto px-12  w-full'>
      <div className='hero-content grid gap-y-4'>
        <div className='hero-main flex flex-col-reverse  md:justify-center items-center md:flex-row'>
            <div className='hero-text flex flex-col gap-2 max-w-[800px] relative'>
              ...
              <span className='flex gap-3'>
                <a href="https://github.com/osocaramelosofer" className='cursor-pointer'>
                  <svg
                ...
                <a href="https://www.linkedin.com/in/fernando-hernández-8b30421b2/" className='cursor-pointer'>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
